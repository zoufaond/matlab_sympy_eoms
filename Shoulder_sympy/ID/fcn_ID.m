function torq = fcn_ID(t,q,dq,ddq,m,cI,sI,hI,ccom,scom,hcom,T_t,T_c,T_s,p,m_el,a_el,cont1,cont2,cont_params,akt,f0m,l0m)
...
fesim = fenew(0,[q,q,q,q,q,q,q,q,q],akt,f0m,l0m);
